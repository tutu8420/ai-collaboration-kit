...
class StandardsSyncManager:
    def __init__(self):
        ...
        self.collaboration_folder = "ai_collaboration_kit"
        self.github_repo = "tutu8420/ai-collaboration-kit"
    ...
    def pull_from_github(self):
        ...
        try:
            ...
            if fetch_result.returncode != 0:
                print(f"❌ 获取远程仓库失败: {fetch_result.stderr}")
                return False
            ...
            if merge_result.returncode == 0:
                ...
                print(f"⚠️ 合并失败，使用本地版本: {merge_result.stderr}")
                return True  # 即使合并失败也继续，使用本地版本
